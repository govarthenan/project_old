...
<div class="box fitness" style="margin-left:17vw;margin-right:2vw; box-shadow: 0 0 1rem rgba(0, 0, 0, 0.2);">
    <p><b>FITNESS CENTER</b></p>
    <a href="./gym_form.php">
        <svg xmlns="http://www.w3.org/2000/svg" height="9em" viewBox="0 0 640 512">
...
<div class="box pool" style="margin-right:2vw; box-shadow: 0 0 1rem rgba(0, 0, 0, 0.2)">
    <p><b>SWIMMING POOL</b></p>
    <a href="./swimming-pool-form.php">
    <svg xmlns="http://www.w3.org/2000/svg" height="9em" viewBox="0 0 576 512">
        <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
...
<div class="box common" style="margin-right:2vw; box-shadow: 0 0 1rem rgba(0, 0, 0, 0.2);">
    <p><b>COMMON AREA</b></p>
    <a href="common_area.php">
    <svg xmlns="http://www.w3.org/2000/svg" height="9em" viewBox="0 0 640 512">
        <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
