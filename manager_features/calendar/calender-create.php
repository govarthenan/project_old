...
<div class="container" style="margin-left:60%;margin-top:7vh">
    ...
    <form method="post" action="#"> <!-- Set the form method and action as needed -->
        <label for="eventDate"><b>Date:</b></label>
        <input style="width: 95%" type="date" id="eventDate" name="eventDate"> <!-- Set the value as needed -->
        <br>

        <label for="eventCategory"><b>Event Category:</b></label>
        <input style="width: 95%" type="text" id="eventCategory" name="eventCategory"> <!-- Set the value as needed -->
        <br>

        <label for="eventSubject"><b>Subject:</b></label>
        <input style="width: 95%" type="text" id="eventSubject" name="eventSubject">
        <!-- Set the value as needed -->
        <br>

        <label for="eventDescription"><b>Description:</b></label>
        <textarea id="eventDescription" name="eventDescription" rows="4" cols="50"></textarea>
        <!-- Set the value as needed -->
        <br>

        <button class="action-button edit-button1" type="submit">Save</button>
    </form>
</div>
