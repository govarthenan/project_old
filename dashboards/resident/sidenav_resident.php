...
// Get username
$sql = "SELECT name FROM " . DB_RESIDENT_TABLE . " WHERE user = '" . $_SESSION['user'] . "'";
...
<div class="top-bar">
    <div class="home-container">
        <a href="/repo/dashboards/resident/dashboard.php" style="text-decoration: none; color: inherit;">
    ...
    <div class="dropdown" style="margin:auto 0;">
        ...
        <div class="dropdown-content">
            <a href="../../resident_features/edit_profile/edit-profile.php">
        ...
        <div class="sidebar">
            ...
            <nav class="navigation">
                ...
                <div class="navi-item">
                    ...
                    <p style="margin-left:1.5rem">Billing</p>
                    </a>

                </div>

                <a href="../../resident_features/amenities/amenities.php"
                   style="text-decoration: none; color: inherit;">
                    <div class="navi-item">
                        <p style="margin-left:1.5rem" p>Amenities</p>
                    </div>
                </a>
                <a href="../../resident_features/complaints/complaints.php"
                   style="text-decoration: none; color: inherit;">
                    <div class="navi-item">
                        <p style="margin-left:1.5rem">Complaints</p>
                    </div>
                </a>
                <div class="navi-item">
                    <a href="#" style="text-decoration: none; color: inherit;">
                        <p style="margin-left:1.5rem">Issues</p>
                    </a>
                </div>

                <div class="navi-item">
                    <a href="../../resident_features/messages/message-view.php"
                       style="text-decoration: none; color: inherit;">
                        <p style="margin-left:1.5rem">Messages</p>
                    </a>
                </div>
